    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="search">
            <label>
              <gmap-autocomplete @place_changed="setPlace" :placeholder="placeholder"> </gmap-autocomplete>
            </label>
        ...
        <div class="col-md-8">
          <GmapMap :center="center" :zoom="zoom" map-type-id="terrain" ref="map">
            <gmap-info-window :options="infoOptions" :position="infoWindowPos" :opened="infoWinOpen" @closeclick="infoWinOpen = false">
              <div class="info-window">
                ...
                <a
                  :href="`https://maps.google.com/maps?daddr=${infoContent.address} ${infoContent.city}, ${infoContent.state} ${infoContent.zip}`"
                  >Get Directions</a
                >
              </div>
            </gmap-info-window>
...
<script>
import serviceCenters from '@/core/explore/serviceCenters.js';
import StoreList from '@/explore/explore.vue';
export default {
  name: 'GoogleMap',
  components: {
    StoreList,
